...
../../parallel -j2 --resume-failed --results ../Output/4_E_bitcoin_epinions_link_direction --joblog ../joblog/4_E_bitcoin_epinions_link_direction_joblog CUDA_VISIBLE_DEVICES=4 python ./main_signed_directed_link.py --direction_only_task --num_classes 5 --dataset {1} --runs 5 --method MSGNN  --q {2} ::: epinions bitcoin_alpha ::: 0.25 0

../../parallel -j2 --resume-failed --results ../Output/4_F_bitcoin_epinions_link_direction --joblog ../joblog/4_F_bitcoin_epinions_link_direction_joblog CUDA_VISIBLE_DEVICES=4 python ./main_signed_directed_link.py --direction_only_task --num_classes 5 --sd_input_feat --weighted_input_feat --dataset {1} --runs 5 --method MSGNN  --q {2} ::: epinions bitcoin_alpha ::: 0.05 0.1 0.15 0.2
