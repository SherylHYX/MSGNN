...
../../parallel -j2 --resume-failed --results ../Output/4_C_bitcoin_slashdot_link_direction --joblog ../joblog/4_C_bitcoin_slashdot_link_direction_joblog CUDA_VISIBLE_DEVICES=4 python ./main_signed_directed_link.py --direction_only_task --num_classes 5 --sd_input_feat  --dataset {1} --runs 5 --method MSGNN  --q {2} ::: slashdot bitcoin_otc ::: 55 0
...
../../parallel -j2 --resume-failed --results ../Output/4_E_bitcoin_slashdot_link_direction --joblog ../joblog/4_E_bitcoin_slashdot_link_direction_joblog CUDA_VISIBLE_DEVICES=4 python ./main_signed_directed_link.py --direction_only_task --num_classes 5 --dataset {1} --runs 5 --method MSGNN  --q {2} ::: slashdot bitcoin_otc ::: 55 0
