...
../../parallel -j2 --resume-failed --results ../Output/3_E_bitcoin_epinions_link_direction --joblog ../joblog/3_E_bitcoin_epinions_link_direction_joblog CUDA_VISIBLE_DEVICES=3 python ./main_signed_directed_link.py --direction_only_task --num_classes 4 --dataset {1} --runs 5 --method MSGNN  --q {2} ::: epinions bitcoin_alpha ::: 55 0
